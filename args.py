...
def get_args():
    ...
    parser.add_argument('--prop', default=1, type=int, help='Number of GAT layers in GraphTransformer')
    ...
    # Training
    parser.add_argument('--source', default='oracle', type=str,
    ...
    parser.add_argument('--gpu', default=1, type=int, help='Number of GPU to use')
    ...
    parser.add_argument('--save_dir', default='/kaggle/input/summer-gear-3/Graph/Graph/trained_models', type=str, help='Directory to save trained models')
    ...
    parser.add_argument('--concept_graph', action='store_true', default=True, help='Whether to use concept graph')
   ...
   # parser.add_argument('--src_max_length', default=1024, type=int, help='Input maximum length of BART')
    ...
    parser.add_argument('--n_epochs', default=2, type=int, help='Number of training epochs')
    # Generation
