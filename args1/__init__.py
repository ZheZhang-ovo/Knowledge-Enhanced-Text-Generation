...
def get_args():
   ...
   # parser.add_argument('--src_max_length', default=1024, type=int, help='Input maximum length of BART')
    parser.add_argument('--src_max_length', default=512, type=int, help='Input maximum length of BART')
    #parser.add_argument('--tgt_max_length', default=1024, type=int, help='Output maximum length of BART')
    parser.add_argument('--tgt_max_length', default=512, type=int, help='Output maximum length of BART')
